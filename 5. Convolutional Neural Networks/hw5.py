...
class nn_mnist_classifier:
    ...
    def update_weights(self):
        ...
        self.fc2.update_weights(-1 * self.v_w_fc2, -1 * self.v_b_fc2)
        self.fc1.update_weights(-1 * self.v_w_fc1, -1 * self.v_b_fc1)
        self.conv_layer_1.update_weights(-1 * self.v_w_cv1, -1 * self.v_b_cv1)
        ########################
        # Q3 ends here
        ########################
